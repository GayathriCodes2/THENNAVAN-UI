    ...
    <div className="flex border p-2">
      ...
      <div className="flex flex-col items-end">
        ...
        <Link href={buyNowLink} className='self-end lg:mt-4 mt-2'>
          <button className="w-full px-1 lg:px-2 py-2 bg-white border-green-500 text-green-500 rounded-md focus:outline-none border hover:bg-green-500 hover:text-white transition duration-300 ease-in-out sm:text-xs">
            Pre Book
          </button>
        </Link>
      </div>

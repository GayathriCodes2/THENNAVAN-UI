    ...
    <footer className="bg-green-600 text-white p-6 mt-3">
      <div className="flex flex-col md:flex-row justify-around items-center">
        ...
        <div className="mb-4 md:mb-0 flex flex-col items-center md:flex-row">
          <a href="/get-in-touch" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">Get in Touch</a>
          <a href="/sell-with-us" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">Sell with Us</a>
          <a href="/terms-and-conditions" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">Terms & Conditions</a>
          <a href="/reviews" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">Reviews</a>
          <a href="/blog" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">Blog</a>
          <a href="/faqs" className="hover:bg-green-500 transition-all rounded p-2 mb-2 md:mb-0">FAQs</a>
        </div>
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          ...
          <a href="https://wa.me/9092993545" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className="h-6 w-6 cursor-pointer fill-current">
